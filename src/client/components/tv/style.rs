...
///
/// `ring-offset-4` + `ring-offset-sheffield-paper` punches a paper-coloured
/// gap between the element and the ring so the ring reads as a ring rather
/// than a thick border at distance.
pub const TV_FOCUSABLE_CLASS: &str = "tv-focusable block w-full text-left rounded-3xl outline-none ring-8 ring-offset-4 ring-offset-sheffield-paper focus:ring-sheffield-sun";
