...
/// happened) creates: T3.5 the `qa/` round files (T3.3 has since written
/// `VERIFICATION.md`), and `BLOCKED.md`/`RESIDUAL.md` only exist if a task blocks.
const PLANNED_ARTEFACTS: &[&str] = &["docs/BLOCKED.md", "docs/RESIDUAL.md"];
